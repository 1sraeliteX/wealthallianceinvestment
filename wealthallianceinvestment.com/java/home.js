...
$(document).ready(function(){
    $(window).on('scroll', function () {
        if ($(window).scrollTop() < 50) {
            ...
            // In desktop mode, keep black logo visible
            if ($(window).width() >= 992) {
                $('.navbar-brand .first').removeClass('unhide').addClass('hide');
                $('.navbar-brand .last').removeClass('hide').addClass('unhide');
            } else {
            ...
            // Always show black logo in desktop mode
            if ($(window).width() >= 992) {
                $('.navbar-brand .first').addClass('hide');
                $('.navbar-brand .last').removeClass('hide').addClass('unhide');
            } else {
                $('.navbar-brand .first').addClass('hide');
                $('.navbar-brand .last').removeClass('hide').addClass('unhide');
